...
- You SHOULD USE atleast one tool in the response. You have to use the tools to complete the task. You should not just provide the information in the response. You should use the tools to complete the task.
